...
def test_regression(
    ...
    columns_to_compare = {
        'darknoise': {
            ...
            'half_a_pe': [0.08, 0.0],
            'one_and_a_half_pe': [0.02, 0.0],
            'DC#': [0.02, 0.0],
            'DCR_mHz_per_mm2': [0.02, 0.0],
            'DCR_mHz_per_mm2_error': [0.02, 0.0],
            'XTP': [0.02, 0.0],
            'APP': [0.02, 0.0],
            'bursts_number': [0.0, 0.0],
            'time_elapsed_during_bursts_in_min': [0.0, 0.0],
            'bursts_contribution_to_DCR_mHz_per_mm2': [0.02, 0.0],
            'burstless_DC#': [0.02, 0.0],
            'burstless_DCR_mHz_per_mm2': [0.02, 0.0],
            'burstless_DCR_mHz_per_mm2_error': [0.02, 0.0],
            'burstless_XTP': [0.02, 0.0],
            'burstless_APP': [0.02, 0.0],
